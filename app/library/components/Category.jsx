      ...
      <ul className=" max-w-full overflow-x-auto flex flew-row gap-4">
        {libraryCategory.map((item) => {
          return (
            <li
              key={item}
              className="h-[30px] min-w-fit px-3 flex justify-center items-center border border-transparent rounded-lg bg-[rgba(144,144,144,0.2)] hover:bg-[rgba(144,144,144,0.45)] cursor-pointer"
            >
              {item}
            </li>
          );
